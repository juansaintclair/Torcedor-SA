...
function($) {
    ...
    Search.VERSION = "1.0.0", Search.prototype.init = function() {
        ...
        }.bind(this), 100)), this.$element.removeClass("closed"), $('body').css('overflow','hidden'), $('.overlay').css('overflow','scroll'),this.$brand.toggleClass("invisible"), $(document).off("keypress.pg.search")) : (this.$element.fadeOut("fast").addClass("closed"), this.$searchField.val("").blur(), $('.overlay').css('overflow','hidden'), $('body').css('overflow','scroll'), setTimeout(function() {
